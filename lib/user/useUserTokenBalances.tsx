...
export const UserTokenBalancesContext = createContext<ReturnType<typeof useUserBalances> | null>(
  null,
);
...
export function UserTokenBalancesProvider(props: { children: ReactNode }) {
  ...
  return (
    <UserTokenBalancesContext.Provider value={balances}>
      {props.children}
...
export const useUserTokenBalances = () =>
  useContext(UserTokenBalancesContext) as ReturnType<typeof useUserBalances>;
